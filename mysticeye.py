...
def authenticate_user():
	valid_users = {'sudo': '@3025YMIR#'}  # Add your valid usernames and passwords here
	...
	while True:
		...
		if username in valid_users and valid_users[username] == password:
			print("Authentication successful. Proceeding with script execution.")
			return True
		else:
...
parser = argparse.ArgumentParser(description=f'MysticEye - Automated Subdomain Enumeration and Information Gathering Tool | v{version}')
...
def banner():
	...
	print(f'{G}{art}{W}\n')
	print(f'{G}[>]{C} Created By   :{W} JMuthusi (MysticScripter)')
